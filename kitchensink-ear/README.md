...
2. If the org.jboss.as.quickstarts.kitchensink_ear.data entered is valid, the new member will be registered and added to the _Members_ display list.
3. If the org.jboss.as.quickstarts.kitchensink_ear.data is not valid, you must fix the validation errors and try again.
...
You should see messages similar to the following:
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound org.jboss.as.quickstarts.kitchensink_ear.data source [jboss/datasources/KitchensinkEarQuickstartTestDS]
